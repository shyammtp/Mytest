...
class Blocks_Front_Search_Results_Clinic extends Blocks_Front_Search_Results
{    
    private $_select;
    private $_offset;
    ...
    public function getResults()
    {
        ...
        $this->_select = App::model('clinic',false)->setLanguage(App::getCurrentLanguageId())->setConditionalLanguage(false)->selectAttributes('*')->filter('clinic_status',array('=',1));        
