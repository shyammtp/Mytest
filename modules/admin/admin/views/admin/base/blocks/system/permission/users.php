...
return array(
    'admin/system_permission_users/index' => array(
        'reference' => array(
            'leftmenu' => array(
                'attributes' => array(
                    'active' => 'permissions/users',
            ...
            'content' => array(
                'attributes' => array(
                    'body_class'  => $blockname.'_class page-header-fixed',
                    'page_title' => 'Role Users Management',
                ),
            ),
            'head' => array(
                'attributes' => array(
            ...
            'maincontent' => array(
                'actions' => array(
                    'setTemplate' => array(
                        'template' => 'system/permissions/users',
                    ),
                ),
                'children' => array(
                    'users_list_grid' => array(
                        'type' => 'Admin/System/Permission/Users/List',
                    ),
                ),
            ),
            'breadcrumbs' => array(
                'actions' => array(
                    'action1' => array(
                        ...
                        'attributes' => array(
                            'crumbname' => 'permission_roles',
                            'crumbinfo' => array('label' => __('Users'),'title' => __('Users')),
                        ),
    ...
    'admin/system_permission_users/edit' => $editBlocks,
    'admin/system_permission_users/new' => $editBlocks,
    'admin/system_permission_users/ajax' => array (
        'reference' => array(
            'content' => array(
                'children' => array(
                    'users_list_grid' => array(
