	  ...
	  <div class="row media-manager">
		...
		<div class="col-xs-6 col-sm-4 col-md-3 image">
		  <div class="thmb">
            ...
            <small style='overflow:auto; height:30px; display:block' class="text-muted" title='<?php echo Arr::get($vid,'description');?>'><?php echo Text::limit_words(Arr::get($vid,'description'),5);?></small>
		  </div><!-- thmb -->
		</div><!-- col-xs-6 -->
