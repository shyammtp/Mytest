 <?php if(App::hasTask('admin/system_permission_roles/edit')){ ?>
 <?php /** <button type="button" id="add_role" class="btn btn-primary btn-cons"><?php echo __('Add a role');?> </button> **/ ?>
  <button type="button"   onclick="setLocation('<?php echo $this->getUrl("admin/system_permission_roles/edit");?>')" class="btn btn-primary btn-cons"><?php echo __('Add a role');?> </button>
  <?php } ?>

<div class="panel panel-default" id="role_form" style="display: none;">
	                <form method="post" id="roleforms" action="<?php echo App::helper('admin')->getAdminUrl('admin/system_permission_roles/saverole');?>">
                ...
                <div class="row">
                  <div class="col-md-8 col-sm-8 col-xs-8">
                    <div class="form-group">
                      ...
                      <div class="controls">
                            <input type="text" maxlength="45" name="role_name" id="role_name" class="form-control mb10" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" maxlength="12" name="tag_bg_color" class="form-control colorpicker-input" placeholder="#000000" id="colorpicker" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" maxlength="12" name="tag_text_color" class="form-control colorpicker-input" placeholder="#000000" id="colortextpicker" />
