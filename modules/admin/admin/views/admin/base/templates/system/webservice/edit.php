...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal tab-form" method="post" action="<?php echo $this->getUrl('admin/system_webservice/save',$this->getRequest()->query());?>" id="webservice">
             ...
             <div class="col-sm-8">
					  ...
					  <select name="role_id" id="source" style="width:100%">
						  <?php foreach($this->getRolesList() as $list):?>
							  <option <?php echo $this->getApi()->getData('role_id')==$list['value'] ? "selected":"";?> value="<?php echo $list['value'];?>"><?php echo $list['label'];?></option>
						  <?php endforeach;?>
					  </select>
             </div>
           </div>
