...
<ul class="nav nav-tabs"></ul>
	...
	<?php $customer = App::model('admin/session')->getCustomer();?>	
			<div class="form-group">
					   ...
					   <div id="tags_tagsinput" class="autocompleteinput">
						   <div id="tags_addTag">
							   ...
							   <?php endif;?>
							   <input type="text" value="" placeholder="<?php echo __('To');?>"  id="user_id" size="150"/>
			...
			<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" maxlength="150" name="subject" id=""  placeholder="<?php echo __('Subject');?>" class="form-control" value="<?php echo $this->_getMessageBlock()->getSubject(); ?>" />
						</div>
			</div>
			<div class="form-group">
...
$(function() {
      SD.Autocomplete.setType('multiple').ajax('user_id','<?php echo $this->getUrl('admin/users/list',array('format'=> 'json','suppressResponseCodes' => 'true'));?>');
});
</script>
<style>
label[for=to] {
