 <?php $deleteurl = App::helper('url')->getUrl('admin/system_permission_roles/deleterole',array('id' =>$this->getRequest()->query('id'))); ?>
 ...
 <div style="float:right;"><?php if($this->getRequest()->query('id')) {  echo $html; } ?></div>
<form method="post" id="role-permission"  action="<?php echo App::helper('admin')->getAdminUrl('admin/system_permission_roles/save',$this->getRequest()->query());?>">
    <input type="hidden" name="role_id" value="<?php echo $this->getRequest()->query('id');?>" />
    <input type="hidden" name="apires[account_id]" value="<?php echo $this->getRole()->getApi()->getData('account_id');?>" />
    <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-8">
          <div class="form-group">
            <label class="form-label"><?php echo __('Role Name');?></label>
            <div class="controls">
                  <input type="text" name="role_name" class="form-control mb10" id="role_name" value="<?php echo $this->getRole()->getRoleName();?>" />
