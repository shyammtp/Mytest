...
<div class="login-container"> 
    <div class="login-box animated fadeInDown">
		...
		<?php if($imagesrc = App::helper('image')->getResizeImage('w200',$adminlogo) ):?> 
        ...
        <div class="login-body">
           ...
           <form id="frm_login" method="post" class="form-horizontal animated fadeIn" action="<?php echo App::helper('store')->getStoreUrl('store/index/postlogin',$this->getRequest()->query());?>"> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <button type="submit"  class="btn btn-info btn-block"><?php echo __('Sign In');?></button>
                </div>
            </div>
            </form>
        </div>
