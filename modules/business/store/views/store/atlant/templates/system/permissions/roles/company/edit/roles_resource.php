...
<form method="post" id="role-permission"  action="<?php echo $this->getUrl('admin/system_permission_roles/savecompany', $this->getRequest()->query()); ?>">
    ...
    <div class="row">
		...
		<div class="controls">
		    <input maxlength="45" type="text" name="role_name" class="form-control mb10" id="role_name" value="<?php echo $this->getRole()->getRoleName(); ?>" />
...
<?php echo $this->getRoleTasks(); ?> 
						...
						<div class="pull-left">
						    ...
						    <button class="btn btn-white btn-cons" type="button" onclick="setLocation('<?php echo $this->getUrl("admin/system_permission_roles/place"); ?>')"><?php echo __('Cancel'); ?></button>
						</div>
					    </div>
					    </form>
					    <script>
