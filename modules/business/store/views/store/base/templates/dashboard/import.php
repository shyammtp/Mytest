...
<?php endif;?>
<form method="post" id="import-dafo" enctype="multipart/form-data" action="<?php echo $this->getUrl('import/load',array('_sl' => 'indi','type' => 'Searchfront'));?>">
<div class="row">
	<div class="col-md-12">
							...
							<div class="controls"> 	 
								<select id="import-sel" name="type" style="width:100%;" title="" class="select2-offscreen" tabindex="-1">
								   <option value="">Select a value</option>
										<option value="user::importStoreData" data-file="Storeuser_importData" data-hint="Text Delimiter is ; and Field delimiter is double quotes">Doctor</option>
										<option value="store_department::importStoreData" data-file="Storedepartment_importData" data-hint="Text Delimiter is ; and Field delimiter is double quotes">Department</option>
										<option value="clinic::importStoreData" data-file="StoreMedical_importData"  data-hint="Text Delimiter is ; and Field delimiter is double quotes">Medical Places</option>
							   </select> 
							</div>
						</div>
