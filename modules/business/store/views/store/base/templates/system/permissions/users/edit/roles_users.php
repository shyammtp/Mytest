...
<form method="post" id="roleforms" action="<?php echo $this->getUrl('admin/system_permission_users/save');?>">
...
<script>
   $(function() {
      SD.Autocomplete.setType('single').ajax('customer_id','<?php echo $this->getUrl('admin/api/list',array('format'=> 'json','suppressResponseCodes' => 'true'));?>');
   });
</script>
<script>
